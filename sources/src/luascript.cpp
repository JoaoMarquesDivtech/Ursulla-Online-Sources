...
void LuaScriptInterface::registerFunctions()
{
	...
	registerEnum(COMBAT_SONGDAMAGE)
	registerEnum(COMBAT_BLOODDAMAGE)
	registerEnum(COMBAT_AIRDAMAGE)
	registerEnum(COMBAT_REALDAMAGE)
	...
	registerEnum(CONDITION_PARAM_SKILL_SCYTHE)
	registerEnum(CONDITION_PARAM_SKILL_DAGGER)
	...
	registerEnum(CONDITION_PARAM_SKILL_SCYTHEPERCENT)
	registerEnum(CONDITION_PARAM_SKILL_DAGGERPERCENT)
	...
	registerEnum(SKILL_SCYTHE)
	registerEnum(SKILL_DAGGER)
	...
	registerEnum(WEAPON_SCYTHE)
	registerEnum(WEAPON_DAGGER)
